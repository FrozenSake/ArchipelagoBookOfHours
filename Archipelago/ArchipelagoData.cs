...
public class ArchipelagoData
{
    ...
    /// <summary>
    /// The seed for this archipelago data. Can be used when loading a file to verify the session
    /// the player is loading is valid for the room it's connecting to.
    /// </summary>
    private string seed;
    ...
    /// </summary>
    /// <returns>the jsonconverted serialization of this</returns>
